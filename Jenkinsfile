pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/hibbarkm'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/Hibbarkm/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('hibbarkm-225')                                                         //<------your MiamiID
    }
